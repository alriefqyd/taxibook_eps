...
import { toWaNumber } from '@/lib/waMessages'

export default function WaButton({ phone, message, title, onClick }: {
  phone: string; message: string; title: string; onClick?: (e: React.MouseEvent) => void
}) {
  return (
    <a
