...
const MSG = {
  en: {
    ...
    thanksBody:  "We've received your message and will use it to improve TaxiBook.",
  ...
  id: {
    ...
    thanksBody:  'Kami telah menerima pesan Anda dan akan menggunakannya untuk meningkatkan TaxiBook.',
