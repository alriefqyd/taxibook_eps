        ...
        {isAssigned && driverPhone && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, width: '100%', padding: '12px 8px', background: '#EFF6FF', color: '#0369A1', border: '1px solid #BAE6FD', borderRadius: 16, fontSize: '13px', fontWeight: 700, textDecoration: 'none', boxSizing: 'border-box' }}
            >
              Call driver
            </a>
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, width: '100%', padding: '12px 8px', background: '#25D366', color: '#fff', border: 'none', borderRadius: 16, fontSize: '13px', fontWeight: 700, textDecoration: 'none', boxSizing: 'border-box' }}
            >
              ...
              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>WhatsApp {driverName || 'driver'}</span>
            </a>
          </div>
        )}
