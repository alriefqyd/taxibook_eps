  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, width: '100%', maxWidth: 260 }}>
        ...
        <button onClick={() => router.push('/coordinator/home')} style={{ padding: '12px', fontSize: 13, fontWeight: 600, background: 'transparent', color: '#006064', border: '1.5px solid rgba(0,96,100,0.2)', borderRadius: 10, cursor: 'pointer', fontFamily: 'inherit' }}>
          Back to home
        </button>
      </div>
    </div>
